...
const NewPlaylist = () => {
  ...
  return !newPlaylist.nrOfTracks > 0 ? (
    ...
    <Box sx={{ borderTop: 1, borderColor: "divider" }}>
      <Typography variant="subtitle1" sx={{ mt: 2 }} gutterBottom>
        ...
        >
          Click here to open on Spotify
        </a>
      </Typography>
      {newPlaylist.notEnoughTracks && (
        <Typography variant="subtitle1" gutterBottom>
          *It seems there weren&apos;t enough tracks to meet the requested
          playlist length. Choosing a lower album diversity might solve this.
        </Typography>
      )}
      <iframe
