...
const OptionsForm = () => {
  ...
  const getAlbumsList = async (e) => {
    ...
    // if (tracklist.length < playlistInfo.nrOfTracks)
    //   dispatch(setNotEnoughTracks(true));
      ...
      <form style={{ display: "flex", justifyContent: "center" }}>
        <FormGroup>
          <Box sx={{}}>
            ...
            <FormControl sx={{ m: 1, minWidth: 150 }}>
              ...
              >
                ...
                {playlistInfoTypeArr[0] !== "new" && (
                  <MenuItem value={70}>70 Tracks</MenuItem>
                )}
                {playlistInfoTypeArr[0] !== "new" && (
                  <MenuItem value={80}>80 Tracks</MenuItem>
                )}
              </Select>
            </FormControl>
            <FormControl sx={{ m: 1, minWidth: 150 }}>
              ...
              <Select
                labelId="tracksPerAlbum"
                value={playlistInfo.tracksPerAlbum}
                label="Album Diversity"
          ...
          <Button
            variant="contained"
            disabled={
              generatedPlaylistInfo.generatePlaylist &&
              !(generatedPlaylistInfo.nrOfTracks > 0)
            }
            sx={{ mb: 3 }}
